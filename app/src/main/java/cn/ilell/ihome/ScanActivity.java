...
import cn.ilell.ihome.scanner.AmbientLightManager;
import cn.ilell.ihome.scanner.BeepManager;
import cn.ilell.ihome.scanner.FinishListener;
import cn.ilell.ihome.scanner.InactivityTimer;
import cn.ilell.ihome.scanner.IntentSource;
import cn.ilell.ihome.scanner.common.BitmapUtils;
import cn.ilell.ihome.scanner.decode.BitmapDecoder;
import cn.ilell.ihome.scanner.decode.CaptureActivityHandler;
import cn.ilell.ihome.scanner.view.ViewfinderView;
import cn.ilell.ihome.scanner.camera.CameraManager;
...
public class ScanActivity extends Activity implements SurfaceHolder.Callback,
    ...
    public void handleDecode(Result rawResult, Bitmap barcode, float scaleFactor) {
        ...
        //finish();
        Map<String, String> params = new HashMap<String, String>();
        params.put("content", ResultParser.parseResult(rawResult).toString());
        params.put("homeid", BaseData.home_id);
        params.put("userid", BaseData.user_id);
        String result = HttpXmlClient.post("http://115.159.30.115/ihome/backdeal/DealScan.php", params);
        if (result.equals("success")){
